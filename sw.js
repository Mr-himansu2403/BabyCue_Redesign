// Service Worker for BabyCue Website Performance Optimization
const CACHE_NAME = 'babycue-v1.0.0';
...
self.addEventListener('push', (event) => {
  if (event.data) {
    ...
    const options = {
      body: data.body,
      icon: '/assets/images/Logo_BabyCue.png',
      badge: '/assets/images/Logo_BabyCue.png',
      vibrate: [100, 50, 100],
      data: {
